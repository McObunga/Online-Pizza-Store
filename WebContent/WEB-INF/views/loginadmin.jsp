...
<body>
	...
	<s:url var="url1" value="/manage">
	</s:url>
	<input type="hidden" value="${url1}" id="urlID" />

	<s:url var="url2" value="/menu">
	</s:url>
	<input type="hidden" value="${url2}" id="urlID" />

	<s:url var="url3" value="/order">
	</s:url>
	<input type="hidden" value="${url3}" id="urlID4" />
	...
	<div class="headerDiv" style="width: 400px; ">
		...
		<a class="menuLink" href="${url}"  ><img
				src="resources/images/logout.jpg" style="height: 40px;" alt="logout" />
		</a></h3>
	</div>
	...
	<table class="mainTable" cellspacing="5">
		<tr>
			<td colspan="2">
				...
				<div id="left1">
					<a class="menuLink" href="${url2}">Menu</a>
				</div>
				<div id="left1">
					<a class="menuLink" href="${url3}"> Order</a>
				</div>
				<div id="left1">
					<a class="menuLink" href="${url1}">Manage </a>
				</div> <br> <br>
				<hr align="right" width="600px">
			</td>
		</tr>
	</table>
