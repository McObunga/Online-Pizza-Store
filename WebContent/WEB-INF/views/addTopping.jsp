...
<body>
	...
	<form:form id="addTopping" name="addTopping" method="post" modelAttribute="addNewTopping">
			...
			<table class="mainTable" cellpadding="5" cellspacing="5">
				...
				<tr>
					...
					<td><form:input id="name" path="ingredientName" maxlength="20" onClick="this.value='';"
									onblur="this.value=!this.value?'Enter Topping Name':this.value;"
							value="Enter Topping Name" /></td>
				</tr>
				<tr>
